-- 0055_get_opds_data_extended.sql
-- Extiende get_opds_data() con campos adicionales de op_ds:
-- fecha_promesa_satelites, fecha_recepcion_satelites, recurso_corte,
-- tipo_despacho, colores, motivo_bloqueo, causa_desvio
